                ...
                <tbody>
                    @forelse ($risks as $risk)
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3 text-sm text-gray-700">{{ $risk->kategoriRisiko->nama }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-gray-600">Tiada data risiko tersedia</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>

...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Risiko Tertinggi dalam Agensi</h1>
        ...
        <div class="bg-white rounded-lg shadow overflow-x-auto">
            <div class="p-6">
                <p class="text-gray-700 mb-4">
                    <strong>Laporan ini menunjukkan risiko yang paling kerap didaftarkan dalam agensi anda.</strong>
                </p>
            </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-100 border-b">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-sm font-semibold text-gray-800">Kekerapan Didaftarkan</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($highestRisks as $index => $item)
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3 text-sm text-gray-700 font-semibold">{{ $item->risiko->nama }}</td>
                            <td class="px-6 py-3 text-sm text-gray-700">{{ $item->risiko->subKategoriRisiko->nama }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-4 text-center text-gray-600">Tiada data risiko tersedia</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>

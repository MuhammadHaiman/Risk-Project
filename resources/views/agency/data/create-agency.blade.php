...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex items-center gap-4 mb-6">
            <a href="{{ route('agency.data.agencies') }}" class="text-blue-600 hover:text-blue-800">
                <i class="fas fa-arrow-left"></i>
            </a>
            <h1 class="text-3xl font-bold text-gray-800">Tambah Agensi Baru ke Sektor {{ $sektor->nama }}</h1>
        </div>

        <div class="bg-white rounded-lg shadow p-8 max-w-4xl">
            <form action="{{ route('agency.data.store-agency') }}" method="POST">
                @csrf
            ...
            <div class="mt-8 bg-blue-50 border-l-4 border-blue-500 p-4">
                ...
                <ul class="text-blue-700 text-sm space-y-1">
                    <li>• Agensi baru akan ditambah ke sektor <strong>{{ $sektor->nama }}</strong></li>

...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex items-center gap-4 mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-800">Sunting Agensi</h1>
        </div>

        <div class="bg-white rounded-lg shadow p-8 max-w-4xl">
            <form action="{{ route('admin.data.update-agency', $agency->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_agensi" id="nama_agensi"
                            ...
                            value="{{ old('nama_agensi', $agency->nama_agensi) }}" placeholder="Nama Agensi" required>
                        @error('nama_agensi')
                        ...
                        <select name="sektor_id" id="sektor_id"
                            ...
                            @foreach ($sectors as $sector)
                                <option value="{{ $sector->id }}"
                                    {{ old('sektor_id', $agency->sektor_id) == $sector->id ? 'selected' : '' }}>
                                    {{ $sector->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="jenis_agensi" id="jenis_agensi"
                            ...
                            value="{{ old('jenis_agensi', $agency->jenis_agensi) }}"
                            placeholder="e.g., Kerajaan, Swasta, Badan Berkanun" required>
                        @error('jenis_agensi')
                            <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="no_tel_agensi" id="no_tel_agensi"
                            ...
                            value="{{ old('no_tel_agensi', $agency->no_tel_agensi) }}" placeholder="e.g., 0312345678"
                            required>
                        @error('no_tel_agensi')
                            <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="website" id="website"
                            ...
                            value="{{ old('website', $agency->website) }}" placeholder="https://www.agensi.gov.my">
                        @error('website')
                            <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_pic" id="nama_pic"
                            ...
                            value="{{ old('nama_pic', $agency->nama_pic) }}" placeholder="Nama Pegawai Perhubungan"
                            required>
                        @error('nama_pic')
                            <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="notel_pic" id="notel_pic"
                            ...
                            value="{{ old('notel_pic', $agency->notel_pic) }}" placeholder="e.g., 0198765432" required>
                        @error('notel_pic')
                            <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="emel_pic" id="emel_pic"
                            ...
                            value="{{ old('emel_pic', $agency->emel_pic) }}" placeholder="pic@agensi.gov.my" required>
                        @error('emel_pic')
                            <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>

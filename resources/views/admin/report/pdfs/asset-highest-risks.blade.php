        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 35%;">Jenis Aset</th>
                    <th style="width: 15%;">Bilangan Risiko</th>
                </tr>
            </thead>
            <tbody>
                @forelse ($data['assets'] as $index => $asset)
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <td>{{ $asset->asset->nama_aset ?? 'N/A' }}</td>
                        <td>{{ $asset->asset->jenisAset->nama ?? 'N/A' }}</td>
                        <td>{{ $asset->risk_count }}</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="4" class="empty-message">Tiada aset dengan risiko</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
